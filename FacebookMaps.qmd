...
# 
# # Generate the GIF with custom delays
# gifski(images, gif_file = "clustering.gif", width = 2000, height = 2000, delay = 1)
#gif doesn't seem to be stopping at the last image for ten seconds, maybe just use delay=1 and repeat the image 10 times
```
